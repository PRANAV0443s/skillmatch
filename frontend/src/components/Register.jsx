...
const Register = () => {
    ...
    return (
        <div className="min-h-[calc(100vh-64px)] flex flex-col justify-center items-center px-4 bg-slate-50 py-12">
            <Card className="w-full max-w-md p-8 sm:p-10">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-slate-800 text-center">Join SkillMatch</h1>
                    <p className="text-slate-500 mt-2 text-center">Your path to a verified career starts here</p>
                </div>
                ...
                <form onSubmit={handleRegister} className="space-y-5">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-slate-700 mb-1.5 ml-1">Account Type</label>
                        <select 
                            onChange={(e)=>setForm({...form, role: e.target.value})} 
                            className="w-full px-4 py-2.5 premium-card premium-input border-slate-200 text-slate-800 focus:outline-none bg-white cursor-pointer"
                        >
                    ...
                    <div className="flex items-start pt-1">
                        ...
                        <label htmlFor="terms" className="text-sm text-slate-600">
                            I agree to the <button type="button" className="text-indigo-600 font-medium">Terms of Service</button> and <button type="button" className="text-indigo-600 font-medium">Privacy Policy</button>.
                        </label>
                    </div>
