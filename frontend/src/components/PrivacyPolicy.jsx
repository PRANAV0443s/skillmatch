    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-12">
            ...
            <div className="prose prose-blue max-w-none text-gray-700 dark:text-gray-300">
                ...
                <h2 className="text-xl font-semibold mt-6 mb-3 text-gray-800 dark:text-gray-200">1. Information We Collect</h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl font-semibold mt-6 mb-3 text-gray-800 dark:text-gray-200">2. How We Use Your Information</h2>
                <div className="mb-4">
                ...
                <h2 className="text-xl font-semibold mt-6 mb-3 text-gray-800 dark:text-gray-200">3. Blockchain and IPFS Data</h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl font-semibold mt-6 mb-3 text-gray-800 dark:text-gray-200">4. Sharing of Information</h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl font-semibold mt-6 mb-3 text-gray-800 dark:text-gray-200">5. Security</h2>
                <p className="mb-4">
                    We take reasonable measures to help protect information about you from loss, theft, misuse and unauthorized access, disclosure, alteration and destruction.
                </p>

                <h2 className="text-xl font-semibold mt-6 mb-3 text-gray-800 dark:text-gray-200">6. Contact Us</h2>
                <p className="mb-4">
