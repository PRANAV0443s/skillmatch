    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-12">
            ...
            <div className="prose prose-blue max-w-none text-gray-700 dark:text-gray-300">
                ...
                <h2 className="text-xl font-semibold mt-6 mb-3 text-gray-800 dark:text-gray-200">1. Acceptance of Terms</h2>
                <p className="mb-4">
                    By accessing and using SkillMatch, you accept and agree to be bound by the terms and provision of this agreement.
                </p>

                <h2 className="text-xl font-semibold mt-6 mb-3 text-gray-800 dark:text-gray-200">2. Description of Service</h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl font-semibold mt-6 mb-3 text-gray-800 dark:text-gray-200">3. User Obligations</h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl font-semibold mt-6 mb-3 text-gray-800 dark:text-gray-200">4. Blockchain Verification</h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl font-semibold mt-6 mb-3 text-gray-800 dark:text-gray-200">5. Limitation of Liability</h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl font-semibold mt-6 mb-3 text-gray-800 dark:text-gray-200">6. Changes to Terms</h2>
                <p className="mb-4">
